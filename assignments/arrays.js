...
for (let i = 0; i < inventory.length; i++) {
  if (inventory[i].id == 33) {
    console.log(`the id is ${inventory[i].id} the year is ${inventory[i].car_year} the make is ${inventory[i].car_make} the model is ${inventory[i].car_model}`)
  }
}
...
for (let i = 0; i < inventory.length; i++) {
  if (inventory[i].id == 50) {
    console.log(`the make is ${inventory[i].car_make} the model is ${inventory[i].car_model}`)
  }
}
